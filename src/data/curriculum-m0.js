...
export const MODULES_M0 = [
  {
    ...
    lessons: [
      { id: 'm0l1', t: 'Variables & Data Types', a: 'Labelled boxes on a shelf', v: 'varbox',
        ...
        q: { q: 'x = 5, then x = "five". In Python, what is x now?', o: ['5 — the first value sticks', 'The string "five" — the name was rebound', 'An error — types cannot change'], x: 1, w: 'The label is a sticky note, not a glued-on box shape: in Python the name simply moves to the new value, even one of a different type. (The glued-label languages like Java would refuse — that is the static-vs-dynamic typing split from this lesson.)' },
        ap: [
      ...
      { id: 'm0l4', t: 'Operators', a: 'The buttons on a calculator', v: 'optable',
        ...
        q: { q: 'What is 17 % 5?', o: ['2 — the leftover after taking out all the fives', '3.4 — the division result', '3 — how many fives fit'], x: 0, w: 'Three fives fit (that is 17 // 5 = 3, using up 15), and % keeps only what is left over: 17 − 15 = 2. The // and % operators are partners — one keeps the fits, the other keeps the leftover.' },
        ap: [
      ...
      { id: 'm0l8', t: 'Reading a Program', a: 'Being the machine for one minute', v: 'tracerun',
        ...
        q: { q: 'a = 3; b = a; a = a + 1. Final values?', o: ['a=4, b=4 — b follows a', 'a=4, b=3 — b copied the value at that moment', 'a=3, b=3 — assignment does not change a'], x: 1, w: 'Trace it line by line: b = a evaluates the right-hand side (3) and stores that value in b at that instant. The later a = a + 1 rewrites only a\'s box — nothing "reaches back" to b. If your table said b=4, you predicted instead of traced — which is exactly the habit this lesson is here to break.' },
        ap: [
